...
for keyword in keywords:
    ...
    # 设定查询的URL
    search_urls = [
        'http://tonkiang.us/hoteliptv.php?X-UCXHRREQUESTID=173056538411615534',
        'http://tonkiang.us/hoteliptv.php?X-UCXHRREQUESTID=173056548465543848'
    ]
