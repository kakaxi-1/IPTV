...
#enter
file_paths = ["txt_files/江苏电信.txt", "txt_files/天津联通.txt", "txt_files/河南电信.txt", "txt_files/Susa.txt"]
...
#enter
file_paths = ["txt_files/四川电信.txt", "txt_files/重庆电信.txt", "txt_files/湖南电信.txt", "txt_files/Susaw.txt"]
